      ...
      10: [
        function ( _dereq_, module, exports ) {
          ...
          debug.humanize = function ( ms ) {
            ...
            if ( ms >= hour ) return ( ms / hour )
              .toFixed( 1 ) + 'h';
            if ( ms >= min ) return ( ms / min )
              .toFixed( 1 ) + 'm';
          ...
          function useColors() {
            ...
            return ( 'WebkitAppearance' in document.documentElement.style ) ||
              ...
              ( navigator.userAgent.toLowerCase()
                .match( /firefox\/(\d+)/ ) && parseInt( RegExp.$1, 10 ) >= 31 );
          }
            ...
            exports.encodePayloadAsArrayBuffer = function ( packets, callback ) {
              ...
              map( packets, encodeOne, function ( err, encodedPackets ) {
                var totalLength = encodedPackets.reduce( function ( acc, p ) {
                  ...
                  return acc + len.toString()
                    .length + len + 2; // string/binary identifier + separator = 2
                }, 0 );
            ...
            ( function ( root ) {
              ...
              function checkScalarValue( codePoint ) {
                if ( codePoint >= 0xD800 && codePoint <= 0xDFFF ) {
                  throw Error(
                    'Lone surrogate U+' + codePoint.toString( 16 )
                    .toUpperCase() +
      ...
      34: [
        function ( _dereq_, module, exports ) {
          ...
          module.exports = function parseuri( str ) {
            ...
            if ( b != -1 && e != -1 ) {
              str = str.substring( 0, b ) + str.substring( b, e )
                .replace( /:/g, ';' ) + str.substring( e, str.length );
            }
            ...
            if ( b != -1 && e != -1 ) {
              uri.source = src;
              uri.host = uri.host.substring( 1, uri.host.length - 1 )
                .replace( /;/g, ':' );
